...
<div class="page-header">
	...
	<form class="form-horizontal" id="FormCadastro" method="POST" action="cadastrarUsuario">  
			...
			<div class="control-group">
				...
				<div class="control-group">			
					<input type="text" class="input-xlarge" id="Nome" placeholder="Nome completo" name="Nome">				
				</div>
			</div>
			<br>
			...
			<div class="control-group">
				<label class="control-label" for="">Idade</label>
					<div class="controls">			
						<input type="text" class="input-xlarge" id="Idade" placeholder="" name="Idade">	
					</div>			
			</div>
			<br>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="input-xlarge" id="Salario" placeholder="Sem pontos nem vírgula" name="Salario">	
				</div>
			</div>
			<br>
